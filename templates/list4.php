...
<nav>
    ...
    <div>
        ...
        <div><a href="display4.php">4 states</a> <a href="list4.php" active>(list)</a></div>
    </div>
</nav>
...
<form class="inline" action="list4.php" method="get">
...
<p>Use the <a href="display4.html">4-states cellular automata generator</a> to generate others !</p>
...
for ($i = $start_with; $i < $start_with + $limit; ++$i) {
    echo '
    <a href="../lib/img4.php?rule='.$i.'&pixel=4&width=500&height=500'.($random ? '' : '&randomstart=on').'">
    <div class="img">
        <img src="../lib/img4.php?rule='.$i.'&width=50&height=50'.($random ? '' : '&randomstart=on').'">
        '.$i.'
    </div>
    </a>
    ';
