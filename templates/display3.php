...
<head>
    <meta charset="utf-8">
    <title>Cellular Automata — 3 states — generator</title>
...
<form class="display" action="../lib/img3.php" target="displayFrame" method="get">
    ...
    <fieldset class="colors">
        <fieldset>
            <label for="color">color 1</label><input type="color" name="color" value="#000000" id="color"> <br />
            <label for="color2">color 2</label><input type="color" name="color2" value="#CCFF00" id="color2"> <br />
            <label for="bgcolor">color 3</label><input type="color" name="bgcolor" value="#ffffff" id="bgcolor">
        </fieldset>
    </fieldset>
