...
<nav>
    ...
    <div>
        ...
        <div><a href="display3.php">3 states</a> <a href="list3.php" active>(list)</a></div>
...
<form class="inline" action="list3.php" method="get">
...
for ($i = $start_with; $i < $start_with + $limit; ++$i) {
    echo '
    <a href="../lib/img3.php?rule='.$i.'&pixel=3&width=500&height=500'.($random ? '' : '&randomstart=on').'">
    <div class="img">
        <img src="../lib/img3.php?rule='.$i.'&width=50&height=50'.($random ? '' : '&randomstart=on').'">
        '.$i.'
    </div>
    </a>
    ';
